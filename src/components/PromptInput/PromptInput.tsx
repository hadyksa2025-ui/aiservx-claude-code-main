...
import { findBuddyTriggerPositions, isBuddyLive, useBuddyNotification } from '../../buddy/useBuddyNotification.js';
...
function PromptInput({
  ...
  const companionSpeaking = useAppState(s => buddyLive && s.companionReaction !== undefined);
  const {
    columns,
    rows
  } = useTerminalSize();
