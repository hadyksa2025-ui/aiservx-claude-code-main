...
// Recovered snapshots don't always get Bun's --define values propagated into
// every lazily loaded module, so install a minimal runtime fallback.
...
globalThis.MACRO ??= {
  ...
  BUILD_TIME: '',
  VERSION_CHANGELOG: '',
  ISSUES_EXPLAINER: 'report it upstream',
